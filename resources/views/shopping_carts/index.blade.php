...
<div class="row" style=" width:500px;display:inline-block;position:relative;float:left;left:100px">
     ...
     @foreach($products as $product)
       ...
       <div class="row" style="top:10px; left:10px; position:relative;"><img style="float:left; width:200px;height:200px;" src="{{url("/products/images/$product->id.$product->extension")}}">
        ...
        <p style="left:50px;top:10px; position:relative;">TALLA :</p>
         <p style="left:50px;top:10px; position:relative;">PRECIO : {{$product->pricing}}</p>
...
<!--        <tr>
        ...
        <tr>
          ...
          <td></td>
          <td class="right">${{$product->pricing}}</td>
        </tr>
          @endforeach 
        <tr>
          <td>Total</td>
